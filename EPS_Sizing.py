...
P_pl = 0.1  #Power requirement of the PL in W
...
t_day = 65  #Day time in minutes
t_ecl = 30  #Eclipse time in minutes
...
M_SA = P_req / P_EOL_sp  #Weight of the solar arrays in kg.
...
V_bat = E_bat / E_delta_bat  #in L.
M_bat = E_bat / E_sp_bat  #in kg.
